...
* `flags`:  More information about mapgen flags can be found in [doc/MAPGEN.md](../MAPGEN.md#clearing-flags-for-layered-mapgens)
...
* More information about monster spawning can be found in [doc/MAPGEN.md](../MAPGEN.md#spawn-item-or-monster-groups-with-place_groups)
