...
Additional information can also be found in the [newspaper snippets](../../data/json/snippets/newspapers.json). Related files in the directory may also be of use.
