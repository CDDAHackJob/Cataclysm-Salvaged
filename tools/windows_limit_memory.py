...
class Kernel32Wrapper:
    ...
    def create_buffer(obj: Any, max_buffer_len: Optional[int] = None) -> str:
        """Creates a ctypes unicode buffer given an object convertible
        to string.
...
class ProcessLimiter:
    ...
    def _query_information_job_object(self, structure: ctypes.Structure,
        ...
        """[Internal] Retrieves limit and job state information from the
        job object.
    ...
    def limit_process_memory(self, memory_limit: int) -> None:
        """Effectively limit the process memory that the target process
        can allocates.
